...
namespace MinhasDespesas.Repoistories.Migrations
{
    ...
    [Migration("20221217162257_DespesaPagamentos")]
    partial class DespesaPagamentos
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MinhasDespesas.Models.Entities.DespesaPagamento", b =>
                {
                    b.Property<Guid>("DespesaPagamentoId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("DespesaPagamentoId");

                    b.HasIndex("DespesaId");

                    b.ToTable("DespesaPagamentos");
                });
            ...
            modelBuilder.Entity("MinhasDespesas.Models.Entities.DespesaPagamento", b =>
                {
                    b.HasOne("MinhasDespesas.Models.Entities.Despesa", "Despesa")
                        .WithMany("Pagamentos")
