...
export const despesaPagamentoCrudSlice = CrudSlice<DespesaPagamentoDto, DespesaPagamentoFilterDto, DespesaPagamentoCreateDto>('DespesaPagamento', 'despesaPagamentoId');